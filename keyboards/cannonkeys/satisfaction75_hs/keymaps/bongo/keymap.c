...
enum custom_keycodes {
    ZENKAKU_HANKAKU = SAFE_RANGE,
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    KC_ESC,            KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   ENC_PRESS,
    ZENKAKU_HANKAKU,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,    XXXXXXX,
    ...
    MO(2),             KC_LALT,  KC_LALT,                      KC_SPC,                                 KC_RGUI,  MO(1),    KC_RALT,  KC_LEFT,  KC_DOWN,    KC_RGHT
  ),
  [1] = LAYOUT_all(
